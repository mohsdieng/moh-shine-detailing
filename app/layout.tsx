...
export const metadata: Metadata = {
  ...
  keywords: [
    "mobile car detailing Raleigh",
    "car detailing Raleigh",
    "ceramic coating Raleigh",
    "paint correction Raleigh",
    "interior car detailing Raleigh",
    "exterior car detailing Raleigh",
    "mobile detailing Durham NC",
    "ceramic coating Durham",
    "auto detailing NC Triangle",
  ],
